      ...
      <div className="relative flex min-h-screen w-full flex-col">
        ...
        <main className="flex flex-1 flex-col items-center">
          <div className="flex w-full max-w-[1440px] flex-1 flex-col">
                ...
                <div className="flex flex-col gap-8 text-left">
                  <div className="flex flex-col gap-4">
                    ...
                    <p className="text-lg font-normal leading-normal text-gray-400">
                      Simulate interviews, analyze your performance, and track
            ...
            <section className="flex flex-col gap-10 px-10 py-20">
              <div className="flex flex-col items-center gap-4 text-center">
                ...
                <p className="text-base font-normal leading-normal text-gray-400 max-w-2xl">
                  Our advanced tools are designed to give you the confidence and
                  skills to excel in any interview.
                </p>
              </div>
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <div className="flex flex-1 flex-col gap-4 rounded-lg border border-gray-700 bg-gray-800 p-6 transition-transform hover:-translate-y-1">
                  ...
                  <div className="flex flex-col gap-1">
                    <h3 className="text-lg font-bold leading-tight text-white font-heading">
                      AI-Powered Interview Simulation
                    </h3>
                    <p className="text-sm font-normal leading-normal text-gray-400">
                      Engage in realistic, AI-driven mock interviews tailored to
                ...
                <div className="flex flex-1 flex-col gap-4 rounded-lg border border-gray-700 bg-gray-800 p-6 transition-transform hover:-translate-y-1">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm font-normal leading-normal text-gray-400">
                      Receive in-depth feedback on your verbal and non-verbal
                ...
                <div className="flex flex-1 flex-col gap-4 rounded-lg border border-gray-700 bg-gray-800 p-6 transition-transform hover:-translate-y-1">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm font-normal leading-normal text-gray-400">
                      Get actionable insights on your performance to pinpoint
                ...
                <div className="flex flex-1 flex-col gap-4 rounded-lg border border-gray-700 bg-gray-800 p-6 transition-transform hover:-translate-y-1">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm font-normal leading-normal text-gray-400">
                      Visualize your progress over time with intelligent
            ...
            <section className="flex flex-col gap-10 px-10 py-20">
              <h2 className="text-center text-4xl font-bold leading-tight tracking-tighter text-white font-heading">
                How It Works
              </h2>
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <div className="flex flex-1 flex-col gap-4 rounded-lg border border-gray-700 bg-gray-800 p-6">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm font-normal leading-normal text-gray-400">
                      Our AI analyzes your responses, tone, and body language to
                ...
                <div className="flex flex-1 flex-col gap-4 rounded-lg border border-gray-700 bg-gray-800 p-6">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm font-normal leading-normal text-gray-400">
                      Review your reports, identify growth areas, and watch your
            ...
            <section className="flex flex-col gap-10 px-10 py-20">
              <div className="flex flex-col items-center gap-4 text-center">
                <h2 className="text-4xl font-bold leading-tight tracking-tighter text-white font-heading">
                  What Our Users Say
                </h2>
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div className="flex flex-col gap-6 rounded-lg border border-gray-700 bg-gray-800 p-6">
                  <p className="text-base font-normal text-gray-400">
                    "The AI feedback was a game-changer. I identified weak spots
                    I never knew I had and walked into my interview with so much
                    more confidence."
                  </p>
                ...
                <div className="flex flex-col gap-6 rounded-lg border border-gray-700 bg-gray-800 p-6">
                  <p className="text-base font-normal text-gray-400">
                    "This tool is incredible for practicing behavioral
                    questions. The reports are detailed and helped me structure
                    my answers much more effectively."
                  </p>
                  <div className="flex items-center gap-4">
                    <img
                      className="h-12 w-12 rounded-full object-cover"
                ...
                <div className="flex flex-col gap-6 rounded-lg border border-gray-700 bg-gray-800 p-6">
                  <p className="text-base font-normal text-gray-400">
                    "I used Smart Interview Coach for a week and landed a job at
                    my dream company. The progress tracker kept me motivated and
                    focused."
                  </p>
                  <div className="flex items-center gap-4">
                    <img
