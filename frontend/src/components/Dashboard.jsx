                    ...
                    practiceHistory.map((practice, index) => (
                      <tr
                        ...
                        className={`border-b border-gray-700 transition-colors duration-200 hover:bg-white/5 ${
                          index === practiceHistory.length - 1 ? 'border-b-0' : ''
                        }`}
                      >
                        <td className="whitespace-nowrap px-6 py-4 text-gray-300">{practice.date}</td>
                        <td className="whitespace-nowrap px-6 py-4 text-gray-300">{practice.topic}</td>
                        <td className="whitespace-nowrap px-6 py-4 text-gray-300">{practice.mode}</td>
                        <td className="whitespace-nowrap px-6 py-4 text-gray-300">{practice.score}%</td>
