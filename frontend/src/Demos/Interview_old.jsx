...
import { fetchAllQuestionsTextOnly } from "../services/fetchQuestions"; // ✅ import util
...
const Interview = () => {
  ...
  // Keep ref synced with current question
  useEffect(() => {
  ...
  // --- Helper: Start Listening for Answer ---
